...
// newTestGCacheStore 创建用于测试的GCache Store实例
func newTestGCacheStore(t *testing.T) store.Store {
	// 创建GCache缓存
...
// TestGCacheStore_Get 测试GCacheStore的Get方法
func TestGCacheStore_Get(t *testing.T) {
	store := newTestGCacheStore(t)
...
// TestGCacheStore_MGet 测试GCacheStore的MGet方法
...
// TestGCacheStore_Exists 测试GCacheStore的Exists方法
...
// TestGCacheStore_MSet 测试GCacheStore的MSet方法
...
// TestGCacheStore_Del 测试GCacheStore的Del方法
